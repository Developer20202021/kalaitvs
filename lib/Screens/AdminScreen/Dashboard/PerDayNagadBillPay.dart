...
class PerDayNagadBillPay extends StatefulWidget {
  const PerDayNagadBillPay({super.key});

  @override
  State<PerDayNagadBillPay> createState() => _PerDayNagadBillPayState();
}

class _PerDayNagadBillPayState extends State<PerDayNagadBillPay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      statusBarColor: Theme.of(context).primaryColor, // Status bar
        ...
        title:  Text("দৈনিক নগদ উত্তোলিত টাকা", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16,fontFamily: "Josefin Sans"),),
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text("${VisiblePaymentMonth} তারিখে ${moneyAdd}৳ টাকা নগদ গ্রহন করেছেন।", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold,fontFamily: "Josefin Sans"),overflow: TextOverflow.ellipsis,),
            ),),
                    ...
                    borderRadius: BorderRadius.circular(5),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text("নগদ: ${AllData[index]["BikeBillPay"]}", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Josefin Sans"),),
