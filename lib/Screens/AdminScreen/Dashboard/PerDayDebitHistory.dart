...
import 'package:tvs_app/Screens/AdminScreen/AllPDF/DebitPDF.dart';




class PerDayDebitHistory extends StatefulWidget {
  const PerDayDebitHistory({super.key});

  @override
  State<PerDayDebitHistory> createState() => _PerDayDebitHistoryState();
}

class _PerDayDebitHistoryState extends State<PerDayDebitHistory> {
...
//  Navigator.of(context).push(MaterialPageRoute(builder: (context) => DebitPDFPreview(CreditData:  AllData, TotalCreditAmount: moneyAdd.toString(),)));
      ...
      statusBarColor: Theme.of(context).primaryColor, // Status bar
        ...
        title:  Text("${VisiblePaymentMonth} তারিখের আয়ের টাকা", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16,fontFamily: "Josefin Sans"),),
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text("${VisiblePaymentMonth} তারিখে ${moneyAdd}৳ টাকা আয় করেছেন।", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold,fontFamily: "Josefin Sans"),overflow: TextOverflow.ellipsis,),
            ),),
                ...
                return   Padding(
                  ...
                  child: ListTile(
                    ...
                    borderRadius: BorderRadius.circular(5),
                            ...
                            title: Text("আয়ের পরিমান:${AllData[index]["DebitAmount"]}৳", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Josefin Sans"),),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text("আয়ের উৎস: ${AllData[index]["DebitName"]}", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "SiyamRupali"),),
