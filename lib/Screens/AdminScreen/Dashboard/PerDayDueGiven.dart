...
class PerDayDueGiven extends StatefulWidget {
  const PerDayDueGiven({super.key});

  @override
  State<PerDayDueGiven> createState() => _PerDayDueGivenState();
}

class _PerDayDueGivenState extends State<PerDayDueGiven> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      statusBarColor: Theme.of(context).primaryColor, // Status bar
        ...
        title:  Text("দৈনিক বাকি দেওয়ার তথ্য", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16,fontFamily: "Josefin Sans"),),
                    ...
                    borderRadius: BorderRadius.circular(5),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text("বাকি দেওয়া হয়েছে: ${AllData[index]["BikePaymentDue"]}", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Josefin Sans"),),
