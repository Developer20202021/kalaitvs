...
class PartsCashMemoPDF extends StatefulWidget {


final List SalesData;

 const PartsCashMemoPDF({super.key,  required this.SalesData});

  @override
  State<PartsCashMemoPDF> createState() => _PartsCashMemoPDFState();
}

class _PartsCashMemoPDFState extends State<PartsCashMemoPDF> {
          ...
          child: pw.Column(children: [
            ...
            pw.Row(
              ...
              children: [
                ...
                pw.Padding(
                  ...
                  pw.Text("KALAI TVS CENTER", style:pw.TextStyle(fontSize: 21, fontWeight: pw.FontWeight.bold, font: ttf, color: PdfColor.fromInt(0xffffff))),
                  pw.Text("KvjvB wUwfGm ‡m›Uvi", style:pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold, font: Banglattf, color: PdfColor.fromInt(0xffffff))),
            ...
            pw.Row(
                ...
                children: [
                  ...
                  // pw.Text("File No:- ${SalesData[0]["FileNo"]}"),


                  pw.Text("Date:- ${SalesData[0]["SaleDate"]}"),
           ...
           pw.SizedBox(height: 10),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text("Product Name", style: pw.TextStyle(fontSize: 11,)),
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["AccessoriesName"].toString().toUpperCase()}", style: pw.TextStyle(fontSize: 14,))))
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text("Product ID", style: pw.TextStyle(fontSize: 11,)),
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["PartsID"]}", style: pw.TextStyle(fontSize: 14,))))
              ...
              // //     pw.Text("Type", style: pw.TextStyle(fontSize: 11,)),
              ...
              // //   decoration:  pw.BoxDecoration(
              // //   border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
              // //       child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["CustomerType"]}", style: pw.TextStyle(fontSize: 14,))))
              ...
              pw.Row(
                ...
                width: 200,
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dotted), top: pw.BorderSide(width: 1, style: pw.BorderStyle.dotted),left: pw.BorderSide(width: 1, style: pw.BorderStyle.dotted),right: pw.BorderSide(width: 1, style: pw.BorderStyle.dotted),)),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["AccessoriesSalePrice"]} tk", style: pw.TextStyle(fontSize: 14,))))
              ...
              //   decoration:  pw.BoxDecoration(
              //   border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
              //       child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["DueAmount"]} tk", style: pw.TextStyle(fontSize: 14,))))
