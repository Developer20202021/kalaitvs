...
class OldDueCashMemoPDF extends StatefulWidget {


final List SalesData;

 const OldDueCashMemoPDF({super.key,  required this.SalesData});

  @override
  State<OldDueCashMemoPDF> createState() => _OldDueCashMemoPDFState();
}

class _OldDueCashMemoPDFState extends State<OldDueCashMemoPDF> {
        ...
        return pw.Center(
          ...
          pw.SizedBox(height: 15),
              ...
              pw.Row(
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["CustomerPhoneNo"]}", style: pw.TextStyle(fontSize: 14,))))
              ...
              pw.Row(
                ...
                decoration:  pw.BoxDecoration(
                border: pw.Border(bottom: pw.BorderSide(width: 1, style: pw.BorderStyle.dashed))),
                    child: pw.Padding(padding: pw.EdgeInsets.only(bottom: 5, left: 30),child: pw.Text("${SalesData[0]["CashIn"]} tk", style: pw.TextStyle(fontSize: 14,))))
